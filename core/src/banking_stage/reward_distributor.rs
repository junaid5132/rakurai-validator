...
impl RewardDistributor {
    ...
    fn handle_leader_bank_recreated(
        ...
        // Record-ix may have been marked landed on the abandoned bank; always restore.
        ...
        } else if tip_turn_to_start.is_none()
            && first_of_consecutive_leader_slots(slot) == slot
        {
